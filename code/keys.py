...
default_alphabet = "air bill see drum each fine gust harp ivy jury crunch look made near oh pit queen red sun trap urge victory well plex yank apple".split(
    " "
)
