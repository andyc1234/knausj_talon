...
default_alphabet = "air back change drum ear fine gust harp ivy jury crunch look made next over pit queen red search trap urge victor word plex yank easy".split(
    " "
)
